...
Verifactu) and rendered to a designed PDF (tenant logo — the branding form turns WebP and other awkward files into PNG
before upload —, tenant colour, VAT and IRPF breakdown, verification QR drawn as
